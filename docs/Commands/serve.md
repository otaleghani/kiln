...
For deploying to the live web, it is recommended to upload the contents of your `public` folder to a dedicated static host (like [[GitHub Pages]], [[Netlify]], or [[Vercel]]) or serve them using a production-grade server like [[Nginx]] or [[Apache]].